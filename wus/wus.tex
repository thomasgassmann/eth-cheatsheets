...
\begin{mainbox}{}
	Sei $X = (X_1, \cdots, X_n)^\top$ eine Zufallsvariable in $\R^n$ und Dichtefunktion $f_X: \R^d \mapsto \R_+$. Sei $Y := \phi(X)$ mit $\phi: \R^d \mapsto \R^d$ invertierbar. Dann gilt:
...
\begin{mainbox}{Variablenwechsel}
	Sei $X$ stetig, $g: \R \mapsto \R$ stetig differenzierbar mit Umkehrfunktion $g^{-1}$. Für die Dichte von $Y := g(X)$ gilt:
	$$
		f_Y(t) = f_X \left( g^{-1}(t) \right) \left| \frac{d}{dt} g^{-1}(t) \right|
	$$
...
\begin{subbox}{Fast sichere Konvergenz}
...
\begin{subbox}{Konvergenz in Wahrscheinlichkeit}
...
\begin{subbox}{Konvergenz in Verteilung}
	Die Folge $X_n$ konvergiert in Verteilung gegen $X$ falls an allen Stellen $x \in \R$:
	$$
		\lim_{n \to \infty} F_n(x) = F(x)
	$$
	Dies wird bspw. beim zentralen Grenzwertsatz verwendet.
\end{subbox}

Für die Konvergenz gilt:

$$
	\begin{matrix} \text{Fast sichere} \\ \text{Konvergenz} \end{matrix} \implies
...
\begin{center}
	...
	\begin{tabularx}{\textwidth}{llXXXXX}
		\toprule
		Diskrete Verteilung & Parameter                                       & \( \E[X] \) & \( \Var[X] \)       & \( p_X(t) \)         & \( F_X(t) \)                     & Eigenschaften \\
		\midrule
		...
		Poisson             & \makecell[l]{ \( \lambda > 0 \): Erwartungswert                                                                                                               \\ und Varianz} & \( \lambda \) & \( \lambda \) & \( \frac{\lambda^t}{t!}e^{-\lambda} \) & \( e^{-\lambda} \sum_{k=0}^{t} \frac{\lambda^{k}}{k!} \) & \begin{rowlist}
			\item $X \sim P(\lambda), Y \sim P(\mu)$ gilt $X + Y \sim P(\lambda + \mu)$
			\item $X_n \sim \text{Bin}(n, p_n)$ mit $n p_n = \lambda$ dann $\lim_{n \to \infty} \P[X_n = k] = \P[X = k]$ wobei $X \sim \text{Poisson}(\lambda)$
		\end{rowlist} \\
...
\begin{center}
	...
	\begin{tabularx}{\textwidth}{llXXXXXX}
		\toprule
		Stetige Verteilung       & Parameter                      & \( \E[X] \)                                                             & \( \Var[X] \)                                                                                               & \( f_X(t) \)                                                                                                                                  & \( F_X(t) \)                                                                           & Eigenschaften                                                                                                          \\
		...
		Normalverteilung         & \makecell[l]{\( \mu: \E[X] \)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            \\ \( \sigma^2 \): Varianz} & \( \mu \) & \( \sigma ^2 \) & \( \frac{1}{\sqrt{2\pi \sigma^2} }e^{-{\frac{(t-\mu)^2}{2\sigma^2} }} \) & \( \frac{1}{ {\sqrt{2\pi \sigma^2}}} \int_{-\infty}^t e^{-\frac{(y-\mu)^2}{2\sigma^2}} \mathrm{d} y \) & \begin{rowlist}
			\item Summe von uiv. normalverteilten Zufallsvariablen ist normalverteilt
		\end{rowlist} \\
		...
		\( \chi ^2 \)-Verteilung & \( n \): Freiheitsgrad         & \( n \)                                                                 & \( 2n \)                                                                                                    & \( \frac{1}{2^{\frac{n}{2}}\Gamma (\frac{n}{2})} t^{\frac{n}{2}-1} e^{-\frac{t}{2}} \text{ für } t>0\)                                        & \(P\left( \frac{n}{2}, \frac{t}{2}\right)  \)                                          & \begin{rowlist}
			                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             \item Für $X_1, X_k$ unabhängig und standardnormalverteilt ist $Q := \sum_{i=1}^k X_i^2$ $\chi^2$-verteilt
