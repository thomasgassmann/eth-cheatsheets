...
\begin{center}
  ...
  \begin{tabular}{cc} 
    ...
    $P_n(x) e^{\alpha x}$ & $R_n(x) \cdot e^{\alpha x}$\\
...
\begin{enumerate}
  ...
  \item Ist $P_n(\alpha) = 0$ eine Nullstelle, dann ist der Ansatz $x^q R_n(x) e^{\alpha x}$ wobei $q$ die Vielfachheit der Nullstelle ist.
\end{enumerate}
