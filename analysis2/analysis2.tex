...
\begin{enumerate}
  ...
  \end{align*}
  Für die Reparametrisierung $\varPhi$ muss dann gelten $\varPhi(c) = a, \varPhi(d) = b, \varPhi \in C'$.
...
TODO: add transformation for polar coodiantes zylidniral and  spherical
