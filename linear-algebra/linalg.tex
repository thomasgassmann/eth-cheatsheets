...
Man nennt $A^+ = (A^\hermconj A)^{-1} A^\hermconj$ auch die Pseudoinverse von $A$, da $A^+ A = I$.
...
$A V_r = U_r \Sigma_r$ ist die reduzierte Form der Singulärwärtszerlegung. Es gilt dabei $U_r U_r = I$ sowie $V_r^\hermconj V_r = I$.

Aus der Singulärwärtszerlegung folgt auch dass die $r$ positiven \textbf{Eigenwerte von $A^\hermconj A$ und $AA^\hermconj$} gleich sind, die Vielfachheit des Eigenwertes $0$ aber $n-r$ respektive $m-r$ ist.
