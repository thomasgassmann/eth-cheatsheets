...
\begin{subbox}{Eigenschaften von Eigenwerten und Eigenvektoren}
  ...
  \end{align*}
  $\lambda$ ist ein Eigenwert von $A$ genau dann wenn $\lambda$ eine Nullstelle von $\chi_A$ ist.
  
  Die geometrische Vielfachheit eines Eigenwertes ist immer kleiner oder gleich der algebraischen Vielfachheit des Eigenwertes.
\end{subbox}
