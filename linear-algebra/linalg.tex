...
\begin{subbox}{Skalarprodukte}
  $\langle x, y \rangle_V$ ist ein Skalarprodukt genau dann wenn $\langle x, y \rangle_V \coloneqq x^\hermconj A y$ wobei $A$ eine hermitesche Matrix mit strikt positiven Eigenwerten ist (positiv-definit). 
\end{subbox}
