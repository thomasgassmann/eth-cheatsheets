...
\begin{subbox}{Eigenwerte und Eigenvektoren finden}
  \begin{enumerate}
    ...
    \item Für jedes $\lambda_k$ bestimme die Menge an Lösungen für $(A - \lambda_k I)x = 0$ (Eigenvektoren)
  \end{enumerate}
\end{subbox}
...
$A$ wird durch $V$ diagonalisiert. Eine Matrix ist genau dann diagonalisierbar wenn für alle Eigenwerte \textbf{die geometrische Vielfachheit der algebraischen Vielfachheit entspricht}.
