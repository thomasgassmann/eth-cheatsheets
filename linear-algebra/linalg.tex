...
Zwei Unterräume $U, W \subseteq V$ heissen \textbf{komplementär} falls jedes $x \in V$ eine eindeutige Darstellung $x = u + w$ mit $u \in U$ und $w \in W$ hat. Man schreibt $V = U \oplus W$.

\begin{subbox}{Komplementäre Unterräume}
  Seien $U, W \subseteq V$ Unterräume von $V$. Dann sind $U$ und $W$ komplementär genau dann wenn $U \cap W = \{0_V\}$.
\end{subbox}
